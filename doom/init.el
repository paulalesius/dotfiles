...
(doom! :input
       ...
       :tools
       ;;ansible
       debugger          ; FIXME stepping through code, to help you add bugs, +lsp uses dap-mode, without +lsp it uses realgud
       ;;direnv
       ;;docker
       ...
       ;;data              ; config/data formats. packages.el seems to add csv-mode.el and config.el something for XML/POM/XSLT
