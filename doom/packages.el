...
;;;(package! doom-golden-ratio :recipe (:local-repo "/home/noname/projects/doom-golden-ratio"
;;;                                     :files ("*.el")
;;;                                     :build (:not compile)))
...
;;(package! rust-web
;;  :recipe (:local-repo "/usr/src/com.unnsvc/com.unnsvc.emacs"
;;           :files ("rust-web/rust-web.el")
;;           :build (:not compile)))
